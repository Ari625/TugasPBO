...
public class Human2D extends JApplet{
    ...
    class PanelHuman extends JPanel implements Runnable{
        ...
        AnimasiOrang orang = new AnimasiOrang(this, xHuman, yHuman, vHuman);
    ...
    public void drawMatahari(Graphics2D g2, int x, int y){
        ...
        GradientPaint warnaMatahari = new GradientPaint(870, 20, Color.orange,
        950, 0, Color.yellow);
    ...
    GradientPaint warna = new GradientPaint(0, 0, Color.white, 0, 250,
    Color.yellow);
    g2.setPaint(warna);
    g2.fill(langit);
    }
    ...
    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
    RenderingHints.VALUE_ANTIALIAS_ON);
    g2.setStroke(new BasicStroke(15, BasicStroke.CAP_ROUND,
    ...
    GlyphVector gv = font.createGlyphVector(frc, "Berjalan jalan");
